...
literalString = "";
    ...
    var tblRow =    "<tr><td>" + LogData.logs[x].NcrNo + 
                    ...
                    if (LogData.logs[x].Status == "Open"){
                        ...
                        tblRow += "</td><td><button class=" +'button' + " id=" +LogData.logs[x].NcrNo+" type=" +"button" + " " + "onclick = editNCR(this.value);" + "location.href="+"'formViewFromLog.html'" + " value=" + LogData.logs[x].NcrNo +">View</button>"
                        }else{
